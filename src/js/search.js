  ...
  function show_results(){
    ...
    results.forEach(function(page) {
      if (page.doc.body !== '') {
        ...
        entry.innerHTML = '<a href class="flex m-2 p-3 no-underline hover:underline text-neutral-900 dark:text-neutral-100 bg-white dark:bg-neutral-800 dark:hover:bg-neutral-700"><span class="inline-block text-right w-36 pr-4 font-bold text-base"></span><span class="w-80 pl-4 border-l border-neutral-200 dark:border-neutral-200"></span></a>';
